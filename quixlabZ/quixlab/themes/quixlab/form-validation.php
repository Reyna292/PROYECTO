                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="insertar.php" method="POST" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="val-username" placeholder="Nombre del alumno..">
                                            </div>
                                        </div>
                                               <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-apellidos" name="val-apellidos" placeholder="Nombre del alumno..">
                                            </div>
                                        </div>
                                     ...
                                     <br>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Nombre de Usuario<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-nametag" name="val-nametag">
                                            </div>
                                        </div>
