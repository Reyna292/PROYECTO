                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form method="POST" class="mt-5 mb-5 login-input" action="validarlogin.php">
                                ...
                                <p class="mt-5 login-form__footer">No tienes cuenta? <a href="page-register.html" class="text-primary">Resgistrate </a> ahora</p>
                            </div>
                        </div>
                    </div>
                </div>
